...
slices.add_task(u(phi=np.pi/2), name='u_mer(phi=0.5pi)')
slices.add_task(u(phi=3*np.pi/2), name='u_mer(phi=1.5pi)')
slices.add_task(B_vec(phi=np.pi/2), name='B_mer(phi=0.5pi)')
slices.add_task(B_vec(phi=3*np.pi/2), name='B_mer(phi=1.5pi)')
slices.add_task(rho(phi=np.pi/2), name='rho(phi=0.5pi)')
slices.add_task(rho(phi=3*np.pi/2), name='rho(phi=1.5pi)')
